...
export class Airline extends _MasterDataAspect(_AirlineAspect(__.Entity)) {}
...
export class Airport extends _MasterDataAspect(_AirportAspect(__.Entity)) {}
...
export function _SupplementAspect<TBase extends new (...args: any[]) => object>(Base: TBase) {
  return class Supplement extends Base {
        SupplementID?: string;
        Price?: number;
        Type?: __.Association.to<SupplementType>;
...
export class Supplement extends _custom._managedAspect(_MasterDataAspect(_SupplementAspect(__.Entity))) {}
...
export function _FlightAspect<TBase extends new (...args: any[]) => object>(Base: TBase) {
  return class Flight extends Base {
    ...
    */
        ...
        to_Airline?: __.Association.to<Airline>;
        to_Airline_AirlineID?: string;
        to_Connection?: __.Association.to<FlightConnection>;
...
export class Flight extends _MasterDataAspect(_FlightAspect(__.Entity)) {}
...
export function _FlightConnectionAspect<TBase extends new (...args: any[]) => object>(Base: TBase) {
  return class FlightConnection extends Base {
        ConnectionID?: string;
        AirlineID?: string;
        DepartureAirport?: __.Association.to<Airport>;
        DepartureAirport_AirportID?: string;
        DestinationAirport?: __.Association.to<Airport>;
...
export class FlightConnection extends _MasterDataAspect(_FlightConnectionAspect(__.Entity)) {}
...
export class Passenger extends _custom._managedAspect(_MasterDataAspect(_PassengerAspect(__.Entity))) {}
...
export class TravelAgency extends _MasterDataAspect(_TravelAgencyAspect(__.Entity)) {}
...
export function _TravelAspect<TBase extends new (...args: any[]) => object>(Base: TBase) {
  return class Travel extends Base {
    ...
    */
        ...
        CurrencyCode_code?: string;
        Description?: string;
        TravelStatus?: __.Association.to<TravelStatu>;
        TravelStatus_code?: TravelStatu_code;
        to_Agency?: __.Association.to<TravelAgency>;
        to_Agency_AgencyID?: string;
        to_Customer?: __.Association.to<Passenger>;
        to_Customer_CustomerID?: string;
        to_Booking?: __.Composition.of.many<Booking_>;
...
export function _BookingAspect<TBase extends new (...args: any[]) => object>(Base: TBase) {
  return class Booking extends Base {
    ...
    */
        CurrencyCode?: _.Currency;
        CurrencyCode_code?: string;
        BookingStatus?: __.Association.to<BookingStatu>;
        BookingStatus_code?: BookingStatu_code;
        to_BookSupplement?: __.Composition.of.many<BookingSupplement_>;
        to_BookSupplement_BookSupplUUID?: string;
        to_Carrier?: __.Association.to<Airline>;
        to_Carrier_AirlineID?: string;
        to_Customer?: __.Association.to<Passenger>;
        to_Customer_CustomerID?: string;
        to_Travel?: __.Association.to<Travel>;
        to_Travel_TravelUUID?: string;
        to_Flight?: __.Association.to<Flight>;
...
export function _BookingSupplementAspect<TBase extends new (...args: any[]) => object>(Base: TBase) {
  return class BookingSupplement extends Base {
    ...
    */
        CurrencyCode?: _.Currency;
        CurrencyCode_code?: string;
        to_Booking?: __.Association.to<Booking>;
        to_Booking_BookingUUID?: string;
        to_Travel?: __.Association.to<Travel>;
        to_Travel_TravelUUID?: string;
        to_Supplement?: __.Association.to<Supplement>;
